...
from network.CMUNeXt import cmunext, cmunext_llm
...
parser.add_argument('--model', type=str, default="CMUNeXt-LLM",
                    choices=["CMUNeXt", "CMUNeXt-LLM"], help='model')
parser.add_argument("--unfreeze", action='store_true')
parser.add_argument("--need_init", action='store_true')
parser.add_argument("--layer", type=int, default=14)
parser.add_argument("--mode", type=str, default="llama", choices=["llama", "deepseek"])
...
def get_model(args):
    if args.model == "CMUNeXt":
        model = cmunext()
    elif args.model == "CMUNeXt-LLM":
        model = cmunext_llm(unfreeze=args.unfreeze, need_init=args.need_init, mode=args.mode)
    else:
        model = None
        print("model err")
        exit(0)
